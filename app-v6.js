...
function renderResumen() {
  ...
  $('#cards-resumen').innerHTML = [
    ...
    { valor: num(datos.bici.reduce((s, e) => s + e.distancia, 0)), etiqueta: 'Km en bici', sub: `${datos.bici.length} ${datos.bici.length === 1 ? 'salida' : 'salidas'}`, color: '#5c7cff' },
